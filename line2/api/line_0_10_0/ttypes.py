...
class Message(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'fromMid', 'UTF8', None, ),  # 1
        (2, TType.STRING, 'toMid', 'UTF8', None, ),  # 2
    ...
    def __init__(self, fromMid=None, toMid=None, toType=None, id=None, createdTime=None, deliveredTime=None, text=None, location=None, hasContent=None, contentType=None, contentPreview=None, contentMetadata=None,):
...
class NotificationItem(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'id', 'UTF8', None, ),  # 1
        (2, TType.STRING, 'fromMid', 'UTF8', None, ),  # 2
    ...
    def __init__(self, id=None, fromMid=None, toMid=None, fromChannel=None, toChannel=None, revision=None, createdTime=None, content=None,):
        self.id = id
        self.fromMid = fromMid
        self.toMid = toMid
    ...
    def write(self, oprot):
        ...
        if self.id is not None:
            ...
            oprot.writeFieldEnd()
        if self.fromMid is not None:
            oprot.writeFieldBegin('fromMid', TType.STRING, 2)
            oprot.writeString(self.fromMid.encode('utf-8') if sys.version_info[0] == 2 else self.fromMid)
            oprot.writeFieldEnd()
        if self.toMid is not None:
